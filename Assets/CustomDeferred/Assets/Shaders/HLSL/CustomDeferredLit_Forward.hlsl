#ifndef CUSTOMDEFERRED_LIT_PASS_FORWARD_INCLUDE
#define CUSTOMDEFERRED_LIT_PASS_FORWARD_INCLUDE
...
void ForwardPassFragment(Varyings input, out half4 outColor : SV_Target0)
{
    float2 uv = input.uv;
